...
const Portfolio = () => {
  ...
  return (
    <div className={`styles.container min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800`}>
      ...
      <Navbar />
      <main className="w-full flex flex-col items-center justify-center sm:flex-row flex-wrap sm:flex-nowrap py-4 flex-grow">
        <div className="w-full flex flex-col pt-1">
          <div className="p-10 bg-yellow-700 rounded-lg flex flex-row justify-evenly">
            <div className="flex flex-col items-center">
              <h1 className="text-white opacity-50 text-lg">Portfolio Value</h1>
              <h1 className="text-white text-4xl font-bold">
                {(portfolioValue / 10e18).toString()} CBTC
              </h1>
            </div>
          </div>
          <span className="font-bold text-2xl m-4 text-white">Your Market Positions</span>
          {markets.map((market) => (
            <PortfolioMarketCard
              id={market.id}
              title={market.title!}
